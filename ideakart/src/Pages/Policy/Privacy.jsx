  ...
  return (
    <>
      ...
      <div className="Privacy_Main_Div">
        <div>
          <h1 className="Privacy_h1">Privacy Policy for IdeaKart</h1>
          <p>
            ...
            by www.ideakart.com and how we use it.
          </p>
          <p className="mainP">Log Files</p>
          <p>
            Like many other Web sites, www.ideakart.com makes use of log files.
          ...
          <p className="mainP">Cookies and Web Beacons</p>
          <p>
          ...
          <p className="mainP">DoubleClick DART Cookie</p>
          <p>
          ...
          <p>
            ...
            site's visitors based upon their visit to www.ideakart.com and other
          ...
          <p className="mainP">Our Advertising Partners</p>
          <p>
          ...
          <p>
            ...
            the advertising partners of www.ideakart.com.
          </p>
          <p>
            These third-party ad servers or ad networks use technology in their
            respective advertisements and links that appear on www.ideakart.com
            and which are sent directly to your browser. They automatically
            receive your IP address when this occurs. Other technologies (such
            as cookies, JavaScript, or Web Beacons) may also be used by our
            site's third-party ad networks to measure the effectiveness of their
            advertising campaigns and/or to personalize the advertising content
            that you see on the site.
          </p>
          <p>
            www.ideakart.com has no access to or control over these cookies that
            are used by third-party advertisers.
          </p>
          <p className="mainP">Third Party Privacy Policies</p>
          <p>
            ...
            certain practices. www.ideakart.com's privacy policy does not apply
          ...
          <p className="mainP">Children's Information</p>
          <p>
            ...
            their online activity. www.ideakart.com does not knowingly collect
            any personally identifiable information from children under the age
            of 13. If a parent or guardian believes that www.ideakart.com has in
            ...
            promptly remove such information from our record
          </p>
          <p className="mainP">Online Privacy Policy Only</p>
          <p>
